...
namespace System.Windows.Forms.Taskbar
{
    ...
    public struct NativePoint
    {
        ...
        public static bool operator !=( in NativePoint first, in NativePoint second ) => !(first == second);
        ...
        public override bool Equals( object obj ) => (obj is NativePoint np) && (this == np);
