...
namespace System.Windows.Forms.Taskbar
{
    ...
    public struct NativeRect
    {
        ...
        public static bool operator !=( in NativeRect first, in NativeRect second ) => !(first == second);
        ...
        public override bool Equals( object obj ) => (obj is NativeRect nr) && (this == nr);
        ...
        internal static NativeRect FromRECT( in RECT r ) => new NativeRect( r.left, r.top, r.right, r.bottom );
    }
}