...
namespace m3u8.download.manager.ipc
{
    ...
    internal static class PipeIPC
    {
        ...
        internal static class NamedPipeServer__Input
        {
            ...
            /// 
            /// </summary>
            public delegate void ReceivedInputParamsArrayEventHandler( UrlInputParams[] array );
            /// <summary>
            /// 
            /// </summary>
...
//Debugger.Launch();
        ...
        internal static class NamedPipeClient__Output
        {
            ...
            public static void Send( string pipeName, UrlInputParams[] array, int connectMillisecondsTimeout = 5_000 )
            {
            ...
            public static async Task Send_Async( string pipeName, UrlInputParams[] array, int connectMillisecondsTimeout = 5_000 )
            {
                using ( var pipeClient = Create_NamedPipeClientStream( pipeName ) )
                {
