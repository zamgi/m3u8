...
namespace m3u8.download.manager.controllers
{
    ...
    internal sealed class cross_download_threads_semaphore : IDownloadThreadsSemaphoreEx
    {
        ...
        public cross_download_threads_semaphore( SemaphoreHolder semaphoreHolder )
        {
        ...
        //---private void SemaphoreHolder_ResetSemaphoreHappens() => Interlocked.Exchange( ref _WaitAcquireCount, 0 );
