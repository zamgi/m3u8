...
namespace m3u8.download.manager.controllers
{
    ...
    internal sealed class SettingsPropertyChangeController : IDisposable
    {
        ...
        public string DownloadListColumnsWidthJson  { [M(O.AggressiveInlining)] get => Settings.DownloadListColumnsWidthJson; [M(O.AggressiveInlining)] set => Settings.DownloadListColumnsWidthJson = value; }        
